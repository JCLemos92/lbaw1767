...
<div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-lg-offset-2">
                    ...
                    <h1 class="text-center">Any questions? Contact us!</h1>

                    <p class="lead text-center">Our team is happy to answer your questions!</p><br>
                        ...
                        <div class="controls">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 col-lg-8 col-xl-4 mx-auto" >
                                    <input type="submit" class="btn btn-block btn-lg btn-primary" value="Send message">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
