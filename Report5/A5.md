...
| R04                | tasks(__IDtask__ UK NN, taskOwner → users NN, projectID → projects NN, taskName NN, taskDescription NN, priority NN, dateLimit, completed, completionDate) |
| R05                | forum(__IDforum__ UK NN, projectID → projects NN, ownerID → users NN, forumTitle NN, forumDescription)                                |
| R06                | Table3(__id1__, id2 → Table2, attribute UK NN)                       |
| R07                | Table4((__id1__, __id2__) → Table3, id3, attribute CK attribute > 0) |
