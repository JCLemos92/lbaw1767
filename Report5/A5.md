...
| R10                | notification(__notification_ID__ UK NN, user_ID → users NN, sender_ID → users NN, project_ID → projects NN, task_ID, notificationText NN, dateSent NN) |
...
| **Functional Dependencies**               |   |
| FD0701          | { notification_ID } → {user_ID, sender_ID, project_ID, task_ID, notificationText, dateSent} |
| FD0702          | { user_ID, sender_ID } → {notification_ID, project_ID, task_ID, notificationText, dateSent} |
| **Normal Form** | BCNF                    |
