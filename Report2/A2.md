...
![alt text](https://github.com/JCLemos92/lbaw1767/blob/master/Report2/actors.PNG "Logo Title Text 1")
...
US24|Respond to project invites|Medium|As an Authenticated User, I want to accept/refuse invites to join a project 
...
US36|Edit comments|Low|As a Project Member, I want to edit my comments on the forum posts, so that I can fix my comment
...
Identifier|Name|Priority|Description
----------|----|--------|-----------
US41|Invite user|High|As a Project Coordinator, I want to invite users, so that I can include users on the project
...
US43|Accept user|High|As a Project Coordinator, I want to accept users, so that I can include users in the project
US44|Edit project description|High|As a Project Coordinator, I want to edit project description, so I can adjust the goals of project
US45|Edit project status|High|As a Project Coordinator, I want to choose between the Concluded/In Progress status for the project
US46|Edit project permissions|High|As a Project Coordinator, I want to choose between the Public/Private status for the project
US47|Promove as coordinator|Medium|As a Project Coordinator, I want to set project members as coordinators, so that I can include others coordinator in the project
US48|Remove Coordinator|Medium|As a Project Coordinator, I want to set coordinators as project members, so that I can remove members' privileges
...
Identifier|Name|Priority|Description
----------|----|--------|-----------
US51|Edit Message|High|As a Message Owner, I want to edit my message, so that I can change what I wrote
US52|Delete Message|High|As a Message Owner, I want to delete my message, so that I can remove a wrong comment 
...
Identifier|Name|Priority|Description
----------|----|--------|-----------
US61|Edit Post|High|As a Post Owner, I want to edit the post, so that I can change what I wrote
US62|Delete Post|High|As a Post Owner, I want to delete my post, so that I can remove a wrong post
US63|Delete Post Messages|High|As a Post Owner, I want to delete users' messages, so that I can remove wrong comments
...
US74|Task Completion|As a Task Owner, I want to set my task status, so that I can set a task as done
...
BR02|Join in avaliable project|A user can only aks to join in avaliable and public projects 
BR03|User birth date|When creating a profile user's can´t choose a date of birth more than 100years ago from current time
BR04|Task duration|When creating a task that task duration can't be more than a year
VER ISSO DE ACORDO COM O A1
VER OUTRAS RESTRIÇÕES NO A1
