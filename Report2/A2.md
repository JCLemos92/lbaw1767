...
US33|Create a forum posts|High|As a Project Member, I want to create forum posts, so that I start a discussion
US34|Comment on a forum post|High|As a Project Member, I want to comment on the forum posts, so that I can tell other users my opinion
US35|Edit comments|Low|As a Project Member, I want to edit my comments on the forum posts, so that I can fix my comment
...
US45|Remove comments|High|As a Project Coordinator, I want to remove comments, so I can avoid unwanted comments
US46|Edit project status|High|As a Project Coordinator, I want to choose between the Concluded/In Progress status for the project
US47|Edit project permissions|High|As a Project Coordinator, I want to choose between the Public/Private status for the project
...
Table 9: Message Owner's user stories
